...
1. EI can be computed differentiably (§3.1)
2. Gradient descent on EI discovers macro-structure (§3.2)
3. Emergent systems pass the Lobotomy Test (§7)
...
4. Therefore, AGI requires EI > threshold ∎
...
10. **Veličković, P., Cucurull, G., Casanova, A., Romero, A., Liò, P., & Bengio, Y.** (2018). Graph Attention Networks. *ICLR*.
...
1. **Measurably conscious** (via Φ, EI, and other metrics)
